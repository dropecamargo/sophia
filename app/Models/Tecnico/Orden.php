...
class Orden extends BaseModel
{
     ...
     * @var array
     */
    protected $fillable =['orden_fecha','orden_tipoorden','otipolicitante','orden_tercero','orden_placa','orden_contador1','orden_contador2','orden_contador3','orden_contador4','orden_contador5','orden_persona','orden_dano','orden_prioridad','orden_problema'];
    ...
    {
        $query = Orden::query();
        $query->select('orden.*', 'tercero_nit','dano_nombre','tipoorden_nombre','prioridad_nombre','solicitante_nombre', DB::raw("CONCAT(tercero_nombre1, ' ', tercero_nombre2, ' ', tercero_apellido1, ' ', tercero_apellido2) as tercero_nombre"));
