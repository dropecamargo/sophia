...
class CreateTcontactoTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tcontacto', function (Blueprint $table) {
            ...
            $table->foreign('tcontacto_tercero')->references('id')->on('tercero')->onDelete('restrict');
            $table->foreign('tcontacto_municipio')->references('id')->on('municipio')->onDelete('restrict');
