<ul class="sidebar-menu">
    ...
    {{-- Administracion --}}
    <li class="treeview {{ in_array(Request::segment(1), ['empresa','modulos','roles','permisos', 'terceros', 'actividades', 'municipios', 'departamentos', 'sucursales']) ? 'active' : '' }}">
        ...
        <ul class="treeview-menu">
            ...
            <li class="{{ in_array(Request::segment(1), ['actividades', 'modulos', 'permisos', 'municipios', 'departamentos', 'sucursales']) ? 'active' : '' }}">
