<ul class="sidebar-menu">
    ...
    {{-- Tecnico --}}
    <li class="treeview {{ in_array(Request::segment(1), ['contratos','ordenes','tiposorden','solicitantes','danos','prioridades','zonas','envioequipos']) ? 'active' : '' }}">
        <a href="#">
        ...
        <ul class="treeview-menu">
            {{-- Modulos Tecnico --}}
            <li class="{{ in_array(Request::segment(1), ['contratos','ordenes','envioequipos']) ? 'active' : '' }}">
                <a href="#">
                    <i class="fa fa-wpforms"></i> Modulos <i class="fa fa-angle-left pull-right"></i>
                </a>
                    <ul class="treeview-menu">
