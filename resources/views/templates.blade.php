    ...
    <div class="row">
    	<div class="form-group col-md-4">
    		...
    		<div class="input-group">
    			...
    			<input type="text" id="producto_costo_promedio" name="producto_costo_promedio" value="<%- producto_costo_promedio %>" placeholder="Promedio" class="form-control input-sm input-toupper" maxlength="20" required>
    		</div>
		</div>
		...
		<div class="form-group col-md-4">
			...
			<div class="input-group">
				...
				<input type="text" id="producto_ultimo_costo" name="producto_ultimo_costo" value="<%- producto_ultimo_costo %>" placeholder="Ultimo" class="form-control input-sm input-toupper" maxlength="20" required>
			</div>
		</div>
    </div>
                    ...
                    <div class="form-group col-md-12">
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                ...
                                {{--<li><a href="#tab_modelos" data-toggle="tab">Modelos</a></li>
                                <li><a href="#tab_tipos" data-toggle="tab">Tipos</a></li>
