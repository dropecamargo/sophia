	...
	<div class="row">
        <div class="form-group col-sm-2 col-md-offset-2">
            <div class="input-group input-group-sm">
                ...
                <input id="producto_tipo_search" placeholder="Serie" class="form-control producto-koi-component" name="producto_tipo_search" type="text" maxlength="15" data-wrapper="producto_create" data-name="producto_nombre_search" data-tipo="EQ" data-asignaciones="false" required>
            </div>
        </div>
